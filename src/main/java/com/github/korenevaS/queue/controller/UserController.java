...
import com.github.korenevaS.queue.service.RoleService;
import com.github.korenevaS.queue.service.UserService;
...
public class UserController {
    ...
    @GetMapping("/my-receipt/{id}")
    @ResponseBody
    public ResponseEntity<List<Receipt>> getReceipts(
            @PathVariable("id") Integer userId
    ) {
        return ResponseEntity.ok().body(userService.getReceipt(userId));
    }
